...
namespace ABMS_backend.Repositories
{
    ...
    {
        Task<ResponseData<string>> createNotificationForReceptionistAsync(NotificationForRecepionistDTO dto);
        ...
        Task<ResponseData<string>> DeleteNotificationsByServiceIdAsync(string serviceId);
    }
}
